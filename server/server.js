...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DtatdUdz.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-DInePxFg.js"),
...
var ROUTER_BASEPATH = "MadhyaPradeshCaveArt";
var SERVER_FN_BASE = "/MadhyaPradeshCaveArt/_serverFn/";
